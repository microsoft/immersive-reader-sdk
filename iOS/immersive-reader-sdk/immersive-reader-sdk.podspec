Pod::Spec.new do |spec|
  ...
  spec.license      = "MIT"
  spec.author       = { "Immersive Reader SDK" => "MeganRoach" }
  spec.platform     = :ios, "9.0"

  spec.source       = { :git => "https://github.com/microsoft/immersive-reader-sdk/immersive-reader-sdk/iOS.git", :branch => "master", :tag => "1.0.0" }
