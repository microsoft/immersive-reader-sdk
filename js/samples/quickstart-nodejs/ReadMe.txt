...
2. Navigate to the samples/quickstart-nodejs directory
...
3. Run "npm start" (or "nodemon start" if you want to view changes you make after doing a browser refresh)

4. View the sample at http://localhost:3000
