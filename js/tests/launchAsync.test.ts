...
describe('Utility method isValidSubdomain', () => {
    it('should return false', () => {
        ...
        expect(isValidSubdomain(null)).toBe(false); // For legacy token authentication
        expect(isValidSubdomain(undefined)).toBe(false); // For legacy token authentication
        expect(isValidSubdomain('')).toBe(false); // For legacy token authentication
    });
